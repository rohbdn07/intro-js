(function($) {
  ...
  // }
  // function myclose() {
  //   var list = document.getElementById("popup1");
  //   list.getElementsByClassName("close")[0].style.visibility = "hidden";
  // }

  // // document.addEventListener("mouseover", hide);
  // list.addEventListener("click", myclose);
  var cl = document.getElementById("popup1").getElementsByClassName("close")[0];
  cl.addEventListener("click", hide);
  // document
  //   .getElementById("popup1")
  //   .getElementsByClassName("close")[0]
  //   .addEventListener("click", hide);
  var sub = document.getElementById("subscribe_popup");
  var come = sub.getElementsByClassName("button")[0];
